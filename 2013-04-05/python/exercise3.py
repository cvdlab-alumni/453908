...
northPiano1 = STRUCT([facciataSpionciniNord1P1,facciataSottofinestaNord1P1]);

#piano 2
facciataSpionciniNord1P2 = T([3])([3.2])(facciataSpionciniNord1P1);
facciataSottofinestaNord1P2 = T([3])([3.2])(facciataSottofinestaNord1P1);
northPiano2 = STRUCT([facciataSpionciniNord1P2,facciataSottofinestaNord1P2]);
...
northPiano3 = STRUCT([facciataSpionciniNord1P3,facciataSottofinestaNord1P3]);
...
southPiano2 = STRUCT([facciataChiusaSouth1P2]);
...
southPiano1 = STRUCT([muroTerrazzoSudPiano1T,ringhieraTerrazzoSudPiano1T,ringhieraTerrazzoSudPiano2T,ringhieraTerrazzoSudPiano3T,ringhieraTerrazzoSudPiano4T,ringhieraTerrazzoSudPiano5T,ringhieraTerrazzoSudPiano6T]);
...
eastPiano1 = STRUCT([facciataChiusaEst1P1,facciataChiusaEst2P1,facciataChiusaEst3P1,facciataChiusaSottoFinestra1P1]);
...
eastPiano2 = STRUCT([facciataChiusaEst1P2,facciataChiusaEst2P2,facciataChiusaEst3P2,facciataChiusaSottoFinestra1P2]);
...
eastPiano3 = STRUCT([facciataChiusaEst1P3,facciataChiusaSottoFinestra1P3,muroTerrazzo1P3,colonnaAngoloTerrazzoT]);
...
westPiano0 = STRUCT([facciataChiusaWest1P0,facciataChiusaSottoFinestraPiccWest1P0,muroSopraFinestraPiccWest1P0,muroIntornoFinestraPiccWest1P0]);
#piano1 
...
westPiano1 = STRUCT([facciataChiusaWest1P1,muroSottoFinestraWest1P1,muroDopoFinestraWest1P1]);
#piano2
...
westPiano2 = STRUCT([facciataChiusaWest1P2,facciataChiusaWest2P2,muroSottoSpionciniWest1P2,muroSpionciniWest1P2]);
